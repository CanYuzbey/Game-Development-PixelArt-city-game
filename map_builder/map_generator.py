...
class MapGenerator:
    ...
    def from_dict(cls, data: dict) -> 'MapGenerator':
        ...
        config = MapConfig(
            ...
            connector_density      = cfg_data.get('connector_density',      0.65),
            connector_spacing      = cfg_data.get('connector_spacing',      8),
            avenue_spacing         = cfg_data.get('avenue_spacing',         18),
            min_block_depth        = cfg_data.get('min_block_depth',        2),
            connector_max_length   = cfg_data.get('connector_max_length',   20),
            connector_turn_bias    = cfg_data.get('connector_turn_bias',    0.08),
            roundabout_count       = cfg_data.get('roundabout_count',       8),
            diagonal_streets       = cfg_data.get('diagonal_streets',       2),
